...
!------------------------------------------------------------------------------------------------
   ...
   use pmgrid,    only: beglatdyn, endlatdyn, loc_JB, loc_JE, iam, masterproc, &
                        beglatdynex,endlatdynex !!zhh
...
!----------------------------------Local workspace----------------------------------
!-----------------------------------------------------------------------
#include <comhyb.h>  ! for hyam, hyai, hybm, hybi
#include <comctl.h> 
!-----------------------------------------------------------------------
...
! set coefficient for flexible leaping-point zonal difference (zhh 2005.8. 26modify: 2006.3.20)
      bn  = 18.0
      en  = 58.0
      bs  = 180.0 - bn  ! 162.0
      es  = 180.0 - en  ! 122.0
