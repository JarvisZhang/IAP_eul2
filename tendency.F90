...
! Author :    ZhangHe
! Completed : 2005.8.26
! Update: 2007.4.23, ZhangHe, change 'LADDSS' to 'NADDSS'
!         2007.7.20, ZhangHe, add the data of NADDSS
...
!!   use IAP_grid,  only: NX, NY, NL
   ...
   real(r8), allocatable :: DQ(:,:,:)     ! tendency of QT
   real(r8), allocatable :: DQliq(:,:,:)  ! tendency of QTliq
   real(r8), allocatable :: DQice(:,:,:)  ! tendency of QTice
...
!!   real(r8), allocatable :: SQ(:,:,:)     ! soure & sink tendency of QT
