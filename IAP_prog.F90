...
! Author :    ZhangHe
! Completed : 2005.8.26
! Update    : 2007.4.25, ZhangHe, correct the unit of pressure from 'Pa' to 'hPa'
!             2007.5.10, ZhangHe, change the module name 'prognostic' ==> 'IAP_prog'
!             2007.5.14, ZhangHe, change 'GHS(IM,NY)' ==> 'GHS(NX,NY)'
!             2008.6.9, ZhangHe, parallel version: NY ==> beglatdynex:endlatdynex
!             2008.6.10, ZhangHe, add sub. initialize_IAPprog
!------------------------------------------------------------------------------------------------
   use shr_kind_mod, only: r8 => shr_kind_r8
   use IAP_grid,     only: NX, NY, NL, NZ
   use pmgrid
!,       only: beglatdynex, endlatdynex
...
!jjr need change NL to beglev:endlev
!-----------------------------------------------------------------------------------------------
   use tendency
!
      ...
      allocate ( Qliq  (NX,beglev:endlev,beglatdynex:endlatdynex) )
      allocate ( Qice  (NX,beglev:endlev,beglatdynex:endlatdynex) )
      allocate ( QTliq (NX,beglev:endlev,beglatdynex:endlatdynex) )
      allocate ( QTice (NX,beglev:endlev,beglatdynex:endlatdynex) )
...
! for tendency
      ...
      allocate ( DQliq (NX,beglev:endlev,beglatdynex:endlatdynex) )
      allocate ( DQice (NX,beglev:endlev,beglatdynex:endlatdynex) )
...
!!      allocate ( SQ    (NX,NL,beglatdynex:endlatdynex) )
!
      P(:,:)        = inf
      Psa(:,:)      = inf
      U(:,:,:)      = inf
