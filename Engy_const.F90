...
!------------------------------------------------------------------------------------------------
   ...
   use pmgrid,    only: beglatdyn, endlatdyn, loc_JB, loc_JE, iam,beglev,endlev,plat,plev
...
!----------------------------------Local workspace----------------------------------------------      
      ...
      real(r8) :: DAPJ
      INTEGER  :: I,K,J,n       ! loop index
      real(r8) :: t1(6), t2(6)
      integer  :: ierr
      integer  :: yr, mon, day, ncsec, dtime, ymd
!-----------------------------------------------------------------------------------------------
!
      TKENG      = ZERO
      TAPEA      = ZERO
...
!----------------------------------Local workspace----------------------------------------------
      ...
      integer  :: L, K, KL, K1, K2, K3, K4, I, J, ierr
#if (defined SPMD)
