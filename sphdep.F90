...
!-----------------------------------------------------------------------
!
! $Id: sphdep.F90,v 1.1.44.7 2004/09/23 17:29:29 erik Exp $
! $Author: erik $
!
!-----------------------------------------------------------------------
...
!!  use scanslt,      only: platd, plond, beglatex, endlatex, i1, nxpt, j1
  use scanslt,      only: platd, plond, beglatex, endlatex, i1, nxpt, nxptj, j1  !zhh 08.04.20
...
!!     if ( phimp(imax,kmax) >= phib(endlatex-nxpt) ) then
     if ( phimpmax >= phib(endlatex-nxptj) ) then   !zhh 2008.4.20
#else
...
!!     else if( phimp(imin,kmin) < phib(beglatex+nxpt) ) then
     ...
     else if( phimpmin < phib(beglatex+nxptj) ) then   !zhh 2008.4.20
#else
...
!!     if ( phidp(imax,kmax) >= phib(endlatex-nxpt) ) then
     if ( phidpmax >= phib(endlatex-nxptj) ) then    !zhh 2008.4.20
#else
...
!!     else if( phidp(imin,kmin) < phib(beglatex+nxpt) ) then
     else if( phidpmin < phib(beglatex+nxptj) ) then    !zhh 2008.4.20
#else
