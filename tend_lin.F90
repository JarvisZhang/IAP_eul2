...
!
!!   print*, '-------- at the beginning of tend_lin --------',iam
...
!!   print*, '-------- at tend_lin: before mpi_move_left --------',iam
        call mpi_move_left(sbuf,rbuf,NX*(2*num1+4))
!!   print*, '-------- at tend_lin: after mpi_move_left --------',iam
!!   print*, 'sbuf =',sbuf
...
!!   print*, '-------- at tend_lin: before mpi_w_a --------',iam
!!   print*, 'lreq =',lreq
        call mpi_w_a(lreq)
!!   print*, '-------- at tend_lin: after mpi_w_a --------',iam
!       tmp1 = 0
!         do while(tmp1.eq.0)
!          call sleep(2)
!       enddo
...
!                      1, NX,beglev,endlev, beglatdyn, beglatdyn,  UT,U )
!      call mp_recv3d_2( src, NX,NL,  NY,                             &
!                      1, NX,beglev,endlev, beglatdynex, endlatdynex,       &
!                      1, NX,beglev,endlev, endlatdynex, endlatdynex, UT,U )



!!   call cpu_time( time_end )
!!   print*, 'run time of FILT2D-PT was ', time_end - time_begin, 'sec'
!!   print*, '-------- at tend_lin 7 --------',iam
!
!     *******************************************************************
!     *******************************************************************
!     ****************         COMPUTE DU & DV        *******************
