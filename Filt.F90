...
!------------------------------------------------------------------------------------------------
   use shr_kind_mod, only: r8 => shr_kind_r8, r16 => SHR_KIND_R16  !zhh 2007.8.5
...
!      integer  :: JBH    ! begin index of latitude to do Lu.FFT + Arakawa.damping 
...
!zhh  do Lu.FFT + Arakawa.damping at north pole
...
!!          AC(N0/2+1) = (0., 0.)
!============================ 2007.8.23 ====================================
!!         A(2)       = ZERO    !? filter zonal wave number 2 ????????
!------------------------------------------------------------------------------------------------
            ISIGN = 1
            CALL IAP_FFT99(A,WORK,TRIGS0,IFAX0,INC,JUMP,N0,LOT,ISIGN)
!------------------------------------------------------------------------------------------------
...
!zhh  do Lu.FFT + Arakawa.damping near south pole
