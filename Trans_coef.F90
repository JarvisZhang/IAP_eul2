...
!          2008.4.7, ZhangHe, add 'CALL DIAGHI' at sub. MDINIT
!          2008.4.27, ZhangHe, add sub. trans_af_mass
...
!------------------------------------------------------------------------------------------------
   ...
   use pmgrid,    only : beglatdyn, endlatdyn, loc_JB, loc_JE, iam,   &
...
!------------------------------------------------------------------------------------------------
      ...
      use IAP_prog, only: U, V, WS, PS2, P  !zhh 2007.11.7
      use vapor,    only: IVMIDT, UVW0
      use Dyn_const, only: PMTOP         !zhh 2007.11.7
...
! ========================= test ==========================
!!   if (masterproc) print*, 'at beginning of sub. MDINIT'
! ===================== zhh 2008.6.12 =====================
...
!	 END DO
	  END DO
      IF ( IVMIDT.EQ.+1 ) THEN
!        IVMIDT: the swich of using wind of middle time layer in computing water vapor advection  
         DO J = beglatdyn, endlatdyn
            DO K = beglev ,endlev
               DO I = 1 ,NX
...
!
!================================================================================================
   SUBROUTINE trans_IAP_tend(IC, DSU, DSV, DST)    !zhh 2008.4.21
!------------------------------------------------------------------------------------------------
...
!================================================================================================
   SUBROUTINE trans_af_mass( ps, t3, q3, ppcnst, n3, npt )
!------------------------------------------------------------------------------------------------
...
!------------------------------------------------------------------------------------------------
      ...
      use pmgrid,    only: plon, plev, plat, beglat, endlat,beglev,endlev
...
!----------------------------------------Arguments-----------------------------------------------
      integer,  intent(in) :: ppcnst   ! number of advected constituents (including water vapor)
